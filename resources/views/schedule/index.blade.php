                ...
                <div class="bg-white/80 backdrop-blur-md shadow-xl rounded-2xl p-8 border border-indigo-100">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-500 text-sm">
                            View all upcoming baptisms, weddings, and church events. Only dates with events can be
                            clicked.
                        </p>
                    </div>
                ...
                var calendar = new FullCalendar.Calendar(document.getElementById('calendar'), {
                    ...
                    dateClick: function(info) {
                        ...
                        if (eventsOnSameDate.length > 0) {
                            const bookedTimes = eventsOnSameDate.map(e => {
                                ...
                                return `${start} - ${end} (${e.extendedProps.event_type})`;
                            }).join('<br>');

                            Swal.fire({
                                icon: 'info',
                                title: 'Some time slots are already booked',
                                html: `<div style="text-align:left">${bookedTimes}</div><br><strong>You can still book another available time slot on this date.</strong>`,
                            ...
                            Swal.fire({
                                ...
                                text: 'No bookings yet for this day. You can proceed to book.',
                                confirmButtonColor: '#4f46e5'
                            });
                        }

                        // ✅ Optional: Redirect or open modal for booking
                        // window.location.href = `/book?date=${clickedDate}`;
                    },
